...
if (!function_exists('eject_customizer_get_css')) {

	function eject_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = eject_customizer_add_theme_fonts($fonts);
...
CSS;
			$rez = apply_filters('eject_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(eject_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = eject_get_scheme_colors($scheme);
	
					// Make theme-specific colors and tints
					$colors = eject_customizer_add_theme_colors($colors);
...
.post_layout_chess .more-link:hover:after,
...
.sc_button_bordered:after,
.sc_button_bordered:hover:after {
...
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(2) .sc_price_item_link,
.sc_price_item_link:hover {
	color: {$colors['inverse_link']} !important;
	background-color: {$colors['text_link']} !important;
	border-color: {$colors['text_link']} !important;
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(2) .sc_price_item_link:after {
	background-color: {$colors['inverse_link']} !important;
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(2) .sc_price_item_link:hover {
	color: {$colors['text_hover']} !important;
	background-color: {$colors['inverse_link']} !important;
	border-color: #ebebeb !important;
}
.sc_price_columns_wrap .trx_addons_column-1_3:nth-child(2) .sc_price_item_link:hover:after {
	background-color: {$colors['text_link2']} !important;
}
...
.sc_form_default .sc_form_field_button button:focus,
...
.search_style_fullscreen.search_opened .search_field::-webkit-input-placeholder {color:#ffffff; opacity: 1;}
.search_style_fullscreen.search_opened .search_field::-moz-placeholder          {color:#ffffff; opacity: 1;}/* Firefox 19+ */
.search_style_fullscreen.search_opened .search_field:-moz-placeholder           {color:#ffffff; opacity: 1;}/* Firefox 18- */
.search_style_fullscreen.search_opened .search_field:-ms-input-placeholder      {color:#ffffff; opacity: 1;}
...
.eject_tabs .eject_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.eject_tabs .eject_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.scheme_self.footer_wrap .widget.widget_nav_menu ul a,
.footer_wrap .widget.widget_nav_menu ul a {
	color: {$colors['text']};
}
.scheme_self.footer_wrap .widget.widget_nav_menu ul a:hover,
.footer_wrap .widget.widget_nav_menu ul a:hover {
	color: {$colors['alter_dark']};
}
...
.sc_form_extra .sc_form_field_button button:hover,
.sc_form_extra .sc_form_field_button button:focus {
    background-color: {$colors['text_hover2']} !important;
	color: {$colors['inverse_link']} !important;
}
...
.sc_recent_news .post_item .post_meta_item.post_categories a {
	background-color: {$colors['text_link']} !important;
	color: {$colors['inverse_link']} !important;
}
.sc_recent_news .post_item .post_meta_item.post_categories a:hover {
	background-color: {$colors['text_link2']} !important;
	color: {$colors['inverse_link']} !important;
}

body .sc_recent_news_style_news-portfolio .post_item .post_featured .post_info a:before {
	color: {$colors['inverse_link']} !important;
}
body .sc_recent_news_style_news-portfolio .post_item .post_featured .post_info a:hover:before,
body .sc_recent_news_style_news-portfolio .post_item .post_featured .post_info a:hover span,
body .sc_recent_news_style_news-portfolio .post_item .post_featured .post_info a:hover {
	color: {$colors['text_link']} !important;
}
body .sc_recent_news_style_news-portfolio .post_item .post_featured .post_info .post_categories a:hover {
	color: {$colors['inverse_link']} !important;
}

.widget.widget_socials .social_item .social_icon {
	background-color: {$colors['alter_bg_color']};
	color: {$colors['text_dark']};
}
...
CSS;
					...
					$rez = apply_filters('eject_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'eject_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>