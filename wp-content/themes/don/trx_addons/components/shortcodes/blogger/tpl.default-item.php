...
?><div <?php post_class( 'sc_blogger_item post_format_'.esc_attr($post_format) ); ?>><?php
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
									...
									apply_filters('trx_addons_filter_args_featured', array(
														...
														'hover' => 'zoomin',
														'thumb_size' => trx_addons_get_thumb_size($args['columns'] > 2 ? (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0 ? 'blogger' : 'big') : 'big'),
														'post_info' => '<span class="post_meta_item post_categories">'.trx_addons_get_post_categories('', false, true).'</span>'
														), 'blogger-default')
								);


//post_info' => '<div class="post_categories">'.trx_addons_get_post_categories('', false, true).'</div>',

	// Post content
	?><div class="sc_blogger_item_content entry-content<?php echo esc_attr(!isset($args['hide_excerpt']) || $args['hide_excerpt']==0 ? '' : ' hide_excerpt'); ?>"><?php
...
// Post content
		if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) {
			?><div class="sc_blogger_item_excerpt">
				...
				// More button
				if ( $show_more ) {
					?><div class="sc_blogger_item_button sc_item_button"><a href="<?php echo esc_url($post_link); ?>" class="sc_button sc_button_simple"></a></div><?php
				}
