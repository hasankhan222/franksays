...
if (!function_exists('eject_trx_addons_get_css')) {
	add_filter('eject_filter_get_css', 'eject_trx_addons_get_css', 10, 4);
	function eject_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
ul.trx_addons_list_custom_circled > li:before {
...
.widget_area_inner .widget_contacts .contacts_info span:before,
.widget_area_inner .widget_contacts .contacts_info > div > a:before,
.widget_area_inner .widget_contacts .contacts_info > a:before {
	color: {$colors['text_dark']};
}
...
.sc_blogger_default .post_featured .post_meta_item.post_categories a {
	background-color: {$colors['text_link']};
}
.sc_blogger_default .post_featured .post_meta_item.post_categories a:hover {
	background-color: {$colors['alter_link']};
	color: {$colors['inverse_link']};
}
...
.sc_blogger_plain .sc_blogger_item .post_meta_item.post_categories a {
	background-color: {$colors['text_link']};
	color: {$colors['inverse_link']};
}
.sc_blogger_plain .sc_blogger_item .post_meta_item.post_categories a:hover {
	background-color: {$colors['alter_link']};
	color: {$colors['inverse_link']};
}
...
/* Services */
.sc_services_hover .sc_services_item:hover .sc_services_item_link_icon:before {
	color: {$colors['alter_link']};
}
...
.scheme_self.sc_testimonials_simple .sc_testimonials_item_content {
	color: {$colors['text_dark']};
}
...
.sc_team_featured .trx_addons_hover_title > a {
	color: {$colors['text_dark']};
}
.sc_team_featured .trx_addons_hover_title > a:hover {
	color: {$colors['text_link']};
}
.sc_team_default .sc_team_item_subtitle a,
.sc_team_short .sc_team_item_subtitle a,
.sc_team_featured .sc_team_item_subtitle a {
	color: {$colors['text_light']};
}
.sc_team .sc_team_item_thumb .sc_team_item_socials .social_item .social_icon {
	background-color: {$colors['text_link']};
...
.sc_services_modern .sc_services_item .sc_services_item_header .sc_services_item_title a:hover {
	color: {$colors['text_link']}
}

.sc_services_modern .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(3) .sc_services_item .sc_services_item_title a:hover,
.sc_services_modern .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(1) .sc_services_item .sc_services_item_title a:hover,
.sc_services_modern .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(1) .sc_services_item .sc_services_item_number,
.sc_services_modern .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(1) .sc_services_item .sc_services_item_link_icon:before {
	color: {$colors['alter_link']}
}



.sc_services_extra .trx_addons_columns_wrap > [class*="trx_addons_column-"]:nth-child(3) .sc_services_item:hover .sc_services_item_title a {
	color: {$colors['text_link']};
}
.sc_services_extra .sc_services_item:hover .sc_services_item_title a {
	color: {$colors['text_link']};
}
